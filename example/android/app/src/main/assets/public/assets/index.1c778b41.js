...
class CapacitorCookiesPluginWeb$1 extends WebPlugin$1 {
  async getCookies() {
...
class CapacitorHttpPluginWeb$1 extends WebPlugin$1 {
...
const SplashScreen = registerPlugin$1("SplashScreen", {
  web: () => __vitePreload(() => import("./web.e59b0dea.js"), true ? [] : void 0).then((m) => new m.SplashScreenWeb())
});
/*! Capacitor: https://capacitorjs.com/ - MIT License */
      ...
      self2.shadowRoot.querySelector("#take-photo").addEventListener("click", async function(e) {
        try {
          OnfidoCapacitor.start({
            sdkToken: "eyJhbGciOiJFUzUxMiJ9..MIGHAkIB4C88RwAF6l6ONrEayOwQHmaP71b3msXzPoc9uTm8wDH78_nP9Gd2EBU9TmfSz4ubg8pVuXebYwSFPD1NpfT9vmcCQX52mVa8UBvhmnpJ_c5FMgU4K5XSWY6GuglmRsQb4i1Vf3zg3IvtP5HAbniyneXY0MgF9t8wLaPgJKDD-T2CMh5X",
            flowSteps: {
              captureFace: {
                type: "PHOTO"
              }
